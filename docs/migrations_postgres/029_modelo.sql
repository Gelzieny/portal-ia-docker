...
CREATE TABLE CIA_MODELO (
    ...
    STAT_MODELO VARCHAR(2) DEFAULT 'DP' NOT NULL,
    ...
    CONSTRAINT FK_CIA_MODELO_FORNECEDOR
...
CREATE OR REPLACE FUNCTION trg_bu_cia_modelo_fn()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER trg_bu_cia_modelo
  BEFORE UPDATE ON cia_modelo
  FOR EACH ROW EXECUTE FUNCTION trg_bu_cia_modelo_fn();
