CREATE TABLE CIA_RESULTADO (
    ID_RESULTADO INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL,

    DATA_CRIACAO TIMESTAMPTZ(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,

    INFO_RESULTADO TEXT NOT NULL,

    ID_BANCO_QUESTAO INTEGER,

    ID_MODELO INTEGER,

    TIPO_RESULTADO VARCHAR(2) NOT NULL,

    INDI_ERRO VARCHAR(1) DEFAULT 'N' NOT NULL,

    INFO_ERRO TEXT,

    QTDE_TOTAL_TOKEN INTEGER NOT NULL,

    QTDE_TOKEN_INPUT INTEGER NOT NULL,

    QTDE_TOKEN_OUTPUT INTEGER NOT NULL,
