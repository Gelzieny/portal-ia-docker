CREATE TABLE CIA_RESULTADO (
    ...
    JSON_RESULTADO CLOB NOT NULL,
    ID_BANCO_QUESTAO NUMBER(9),
    ID_MODELO NUMBER(9),
    ID_METRICA NUMBER(9),
    INDI_ERRO VARCHAR2(1 CHAR) DEFAULT 'N' NOT NULL,
    JSON_ERRO CLOB,
    QTDE_TOTAL_TOKEN NUMBER(9) NOT NULL,
    QTDE_TOKEN_INPUT NUMBER(9) NOT NULL,
    QTDE_TOKEN_OUTPUT NUMBER(9) NOT NULL,

    CONSTRAINT PK_CIA_RESULTADO  PRIMARY KEY (ID_RESULTADO),
    ...
    CONSTRAINT FK_CIA_METRICA
        FOREIGN KEY (ID_METRICA)
        REFERENCES CIA_METRICA (ID_METRICA)
        ON DELETE SET NULL,    
...
COMMENT ON COLUMN CIA_RESULTADO.JSON_RESULTADO IS
...
COMMENT ON COLUMN CIA_RESULTADO.JSON_ERRO IS
