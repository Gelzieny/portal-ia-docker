...
CREATE TABLE CIA_NOTICIA (
    ...
    DESC_RESUMO VARCHAR2(1000 CHAR) NOT NULL,
    ...
    CONSTRAINT PK_CIA_NOTICIA PRIMARY KEY (ID_NOTICIA),
...
COMMENT ON COLUMN CIA_NOTICIA.NOME_TITULO IS
'Título principal da notícia publicada na plataforma.'

COMMENT ON COLUMN CIA_NOTICIA.DESC_RESUMO IS
'Resumo descritivo da notícia utilizada para visualização rápida (tipo do arquivo .md).'

COMMENT ON COLUMN CIA_NOTICIA.DESC_CONTEUDO IS
'Conteúdo completo da notícia publicada (tipo do arquivo .md).'
