CREATE TABLE CIA_FUNCIONALIDADE (
    ID_FUNCIONALIDADE NUMBER(9) DEFAULT 0 NOT NULL,
    CODG_FUNCIONALIDADE VARCHAR2(200 CHAR) NOT NULL,
    ...
    INFO_CAMINHO_MENU VARCHAR2(500 CHAR),
    ...
    CONSTRAINT PK_CIA_FUNCIONALIDADE PRIMARY KEY (ID_FUNCIONALIDADE),
