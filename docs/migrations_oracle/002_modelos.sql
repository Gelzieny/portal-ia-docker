CREATE TABLE CIA_MODELO (
    ...
    INFO_CAPABILIDADE CLOB, 
    STAT_MODELO VARCHAR2(1 CHAR) NOT NULL, 
    ...
    INFO_ENDPOINT_PADRAO VARCHAR2(500 CHAR), 
...
CREATE SEQUENCE SEQ_CIA_MODELO
    START WITH 1
    INCREMENT BY 1
    NOCACHE
    NOCYCLE
...
COMMENT ON COLUMN CIA_MODELO.NOME_CURTO IS
...
'Tipo de autenticação padrão utilizado para acesso ao modelo. 1 = api_key, 2 = bearer, 3 = custom'
