...
CREATE INDEX IDX_CIA_DENUNCIA_USUARIO
    ON CIA_PROMPT_DENUNCIA (ID_USUARIO_DENUNCIANTE)
...
COMMENT ON COLUMN CIA_PROMPT_DENUNCIA.ID_USUARIO_DENUNCIANTE IS
...
COMMENT ON COLUMN CIA_PROMPT_DENUNCIA.ID_USUARIO_RESOLUCAO IS
