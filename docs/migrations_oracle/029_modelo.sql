...
CREATE TABLE CIA_MODELO (
    ...
    DESC_RESUMO_ACESSO VARCHAR2(500 CHAR) DEFAULT '' NOT NULL,
    ...
    CONSTRAINT PK_CIA_MODELO PRIMARY KEY (ID_MODELO),

    CONSTRAINT UK_CIA_MODELO_SLUG UNIQUE (SLUG_MODELO),
...
COMMENT ON COLUMN CIA_MODELO.JSON_CAPACIDADE IS
...
COMMENT ON COLUMN CIA_MODELO.JSON_ETIQUETA IS
